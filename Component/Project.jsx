                ...
                <Modal.Body>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        ...
                        <Form.Control
                            ...
                            onChange={(e)=>{projectObj.projecName=(e.target.value)}}
                        /><br />
...
export const ProjectTable = () =>{
    ...
    const saveEditProject = (obj) =>{
        const newProjectObj = {
            ...
            projecName: obj.projecName ? obj.projecName : projByIdData.projecName ,
                ...
                <Modal.Body>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        ...
                        <Form.Control
                            type="Text"
                            autoFocus
                            placeholder={projByIdData? projByIdData.projecName : null}
                            onChange={(e)=>{projectObj.projecName=(e.target.value)}}
                        /><br />
                        <Form.Label>Project Type</Form.Label>
                        <Form.Control
